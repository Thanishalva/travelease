                ...
                <div class="col-md-4 mb-4">
                    <div class="card feature-card h-100">
                        <div class="card-body text-center">
                            ...
                            <h5 class="card-title">Worldwide Destinations</h5>
                            <p class="card-text">Explore both national and international destinations with our curated packages.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="card feature-card h-100">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">Your safety is our priority. We ensure secure bookings and travel arrangements.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="card feature-card h-100">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">Our customer support team is always ready to assist you with any queries.</p>
                        </div>
                    </div>
                </div>
            </div>
